...
import exercise_fifteen.abstracts.ScannerAbstract;

/**
 * Clase ScannerExerciseFiveteen
 ...
 * Versión: v1-04/06/22
 */
public class ScannerExerciseFifteen extends ScannerAbstract {
    /**
     * Método getIntance()
     * Crea una instancia de la clase ScannerExerciseNine
     * @return una intancia de la clase
     */
    public static ScannerExerciseFifteen getInstance(){
        return new ScannerExerciseFifteen();
    }
    ...
    public Integer getInteger(){
        try {
            ...
            throw new ExceptionExerciseFifteen(exception.getMessage(), exception);
        }
    }
}
